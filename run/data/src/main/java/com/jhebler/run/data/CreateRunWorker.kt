package com.jhebler.run.data

import android.content.Context
import androidx.work.CoroutineWorker
import androidx.work.WorkerParameters
import com.jhebler.core.database.dao.RunPendingSyncDao
import com.jhebler.core.database.mappers.toRun
...
class CreateRunWorker(
    ...
    override suspend fun doWork(): Result {
        ...
        return when(val result = remoteRunDataSource.postRun(run, pendingRunEntity.mapPictureBytes)) {
            is com.jhebler.core.domain.util.Result.Error -> {
                result.error.toWorkerResult()
            }
            is com.jhebler.core.domain.util.Result.Success -> {
